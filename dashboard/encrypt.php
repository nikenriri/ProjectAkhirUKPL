...
<head>
    <title>Halo, <?php echo $data['fullname']; ?> - Aplikasi Enkripsi dan Dekripsi Pendaftaran Siswa Baru</title>
    <meta charset="utf-8">
...
<body class="sidebar-mini fixed">
    <div class="wrapper">
        <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:13pt">Pendaftaran Siswa Baru</a>
        ...
        <aside class="main-sidebar hidden-print">
            <section class="sidebar">
                <div class="user-panel">
                    <div class="pull-left image"><img class="img-circle" src="assets/images/pp.jpg></div>
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-file"></i> Form Enkripsi Pendaftaran Siswa Baru</h1>
                </div>
                <div>
                    <ul class="breadcrumb">
